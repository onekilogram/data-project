...
public class CogradientImgFileManager {
	...
	public static void main(String[] args) {
		try {
			versouSshUtil("192.168.1.50", "dbcluster", "1", 22);
			runCmd("ls ~/kg/", "UTF-8");
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	public static void versouSshUtil(String host, String userName, String password, int port)
			throws Exception {
		log.info("尝试连接到....host:" + host + ",username:" + userName + ",password:" + password
				+ ",port:" + port);
